					...
					<div class="modal-content">
						<div class="modal-header">
							...
							<form action="BBSdelete.do" method="post">
								<div class="jumbotron">
									<h5 class="" id="myModalLabel">회원정보를 다시 입력해주세요</h5><br/>
									...
									<div class="form-group">
										...
										name="bbs_delete_check_Pw" maxlength="20" />
									</div>
								</div>
								 <div class="modal-footer">
									...
									<button type="button" class="btn btn-primary" onclick="infoConfirm();">삭제</button>
								</div>
							</form>
					</div>
				</div>
