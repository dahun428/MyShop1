										...
										<div class="input-group">
											<div class="input-group-prepend">
												<div class="input-group-text">
													<input type="radio" value="inputBox" name="categoryRadio" id="category-input-radio" checked="checked"/>
													<small>카테고리</small>
												</div>
											</div>
											<input type="text" class="form-control" name="categoryInput" id="category-inputBox"/>
										</div>
									</td>
									<td colspan="2">
										<div class="input-group">
											<div class="input-group-prepend">
												<div class="input-group-text">
													<input type="radio" value="selectBox" name="categoryRadio" id="category-select-radio"/>
													<small>선택</small>
												</div>
											</div>
										...
										<div class="input-group">
											<div class="input-group-prepend">
												<label for="discountPrice-rate-select"
													...
													value="rate" name="discountSelect" id="discountSelect-rate" />
													<small>할인율입력</small>
												</label>
											</div>
